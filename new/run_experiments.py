...
for i, dag in enumerate(dags):
    print('=== Simulating strategy %s for DAG %d' % (args.strategy, i))
    strategy_folder = os.path.join(DATA_FOLDER, args.folder, 'dag%d' % i, args.strategy)
    simulate(STRATEGIES[args.strategy], SIM_CONFIG, dag, strategy_folder)
