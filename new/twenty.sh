...
python3 make_dataset.py -p 20 -s 1 -d 50 -t erdos --folder twenty
python3 run_experiments.py -n 12 -b 2 -k 2 --folder twenty --strategy random
python3 run_experiments.py -n 12 -b 2 -k 2 --folder twenty --strategy var-score
python3 run_experiments.py -n 12 -b 3 -k 2 --folder twenty --strategy random
python3 run_experiments.py -n 12 -b 3 -k 2 --folder twenty --strategy var-score
python3 run_experiments.py -n 12 -b 4 -k 2 --folder twenty --strategy random
python3 run_experiments.py -n 12 -b 4 -k 2 --folder twenty --strategy var-score
