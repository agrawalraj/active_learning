...
python3 run_experiments.py -n 12 -b 2 -k 2 --folder twenty_dense --strategy random
python3 run_experiments.py -n 12 -b 2 -k 2 --folder twenty_dense --strategy edge-prob
python3 run_experiments.py -n 12 -b 2 -k 2 --folder twenty_dense --strategy learn-parents
python3 run_experiments.py -n 12 -b 3 -k 2 --folder twenty_dense --strategy random
python3 run_experiments.py -n 12 -b 3 -k 2 --folder twenty_dense --strategy edge-prob
python3 run_experiments.py -n 12 -b 3 -k 2 --folder twenty_dense --strategy learn-parents
python3 run_experiments.py -n 12 -b 4 -k 2 --folder twenty_dense --strategy random
python3 run_experiments.py -n 12 -b 4 -k 2 --folder twenty_dense --strategy edge-prob
python3 run_experiments.py -n 12 -b 4 -k 2 --folder twenty_dense --strategy learn-parents

python3 run_experiments.py -n 30 -b 2 -k 2 --folder twenty_dense --strategy random
python3 run_experiments.py -n 30 -b 2 -k 2 --folder twenty_dense --strategy edge-prob
python3 run_experiments.py -n 30 -b 2 -k 2 --folder twenty_dense --strategy learn-parents
python3 run_experiments.py -n 30 -b 3 -k 2 --folder twenty_dense --strategy random
python3 run_experiments.py -n 30 -b 3 -k 2 --folder twenty_dense --strategy edge-prob
python3 run_experiments.py -n 30 -b 3 -k 2 --folder twenty_dense --strategy learn-parents
python3 run_experiments.py -n 30 -b 4 -k 2 --folder twenty_dense --strategy random
python3 run_experiments.py -n 30 -b 4 -k 2 --folder twenty_dense --strategy edge-prob
python3 run_experiments.py -n 30 -b 4 -k 2 --folder twenty_dense --strategy learn-parents
